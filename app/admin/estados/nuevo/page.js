            ...
            <div className="container px-4 py-8 mx-auto">
                <div className="flex flex-wrap items-center justify-between mb-8">
                    <div className="flex items-center mb-4">
                        ...
                        <span className="mx-2 text-gray-500">/</span>
                        <span className="text-gray-700">Nuevo Estado</span>
                    </div>
                    ...
                    <div className="flex mb-4 space-x-2">
                        ...
                        <PDFDownloadLink
                            document={<EstadoPDF estado={{ ...estado, cliente }} />}
                            fileName={`${estado.numero}.pdf`}
                            className={`bg-secondary text-white px-4 py-2 rounded-md hover:bg-blue-600 transition-colors flex items-center ${!estado.items[0].descripcion ? 'opacity-50 cursor-not-allowed' : ''}`}
                            disabled={!estado.items[0].descripcion}
                        >
                                                ...
                                                <div className="md:hidden">
                                                    ...
                                                    >
                                                        <span className={`text-sm flex-1 ${item.descripcion ? 'text-gray-800' : 'text-gray-400'}`}>
                                                            {item.descripcion || 'Toca para agregar concepto'}
                                                        </span>
                                                ...
                                                <div className="md:hidden">
                                                    ...
                                                    >
                                                        <span className={`text-sm flex-1 ${item.comentarios ? 'text-gray-800' : 'text-gray-400'}`}>
                                                            {item.comentarios || 'Toca para agregar comentarios'}
                                                        </span>
                                                        <svg className="w-5 h-5 ml-2 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15.232 5.232l3.536 3.536m-2.036-5.036a2.5 2.5 0 113.536 3.536L6.5 21.036H3v-3.572L16.732 3.732z" />
                                                        </svg>
                ...
                <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50">
                    <div className="flex flex-col w-full h-full bg-white md:w-11/12 md:h-5/6 md:rounded-lg md:max-w-4xl">
                        ...
                        <div className="flex items-center justify-between p-4 bg-white border-b border-gray-200 md:rounded-t-lg">
                            <h3 className="text-lg font-semibold text-gray-800">Concepto del avance</h3>
                            <button
                        ...
                        <div className="flex flex-col flex-1 p-4 bg-white md:rounded-b-lg">
                            <textarea
                                ...
                                placeholder="Describe detalladamente el concepto del avance...

Ejemplos:
• Avance 30% desarrollo módulo de usuarios
• Entrega de wireframes y diseño inicial
• Implementación sistema de autenticación
• Revisión y correcciones primera etapa
• Instalación y configuración de servidor
• Capacitación equipo de trabajo fase 1"
                                autoFocus
            ...
            {modalComentarios.isOpen && (
                <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50">
                    <div className="flex flex-col w-full h-full bg-white md:w-11/12 md:h-5/6 md:rounded-lg md:max-w-4xl">
                        {/* Header del modal */}
                        <div className="flex items-center justify-between p-4 bg-white border-b border-gray-200 md:rounded-t-lg">
                            <h3 className="text-lg font-semibold text-gray-800">Comentarios del avance</h3>
                            <button
                        ...
                        <div className="flex flex-col flex-1 p-4 bg-white md:rounded-b-lg">
                            <textarea
                                ...
                                className="flex-1 w-full p-4 text-base border border-gray-300 rounded-md resize-none focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                                placeholder="Agrega comentarios adicionales sobre el avance..."
                                autoFocus
                                style={{ minHeight: '200px' }}
                            />
